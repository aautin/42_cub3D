...
/*   Updated: 2024/07/26 07:18:37 by aautin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	free_ptr_allocations(t_vars *vars, t_objs *objs, t_map *map,
	t_player *player)
{
...
static void	ptr_allocations(t_vars **vars, t_objs **objs, t_map **map,
	t_player **player)
{
